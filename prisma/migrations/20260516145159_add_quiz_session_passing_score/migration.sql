...
INSERT INTO "new_QuizSession" ("completedAt", "id", "levelId", "score", "startedAt", "status", "total", "userId") SELECT "completedAt", "id", "levelId", "score", "startedAt", "status", "total", "userId" FROM "QuizSession";
